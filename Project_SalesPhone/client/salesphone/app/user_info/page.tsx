...
export default function UserInfo () {
    ...
    useEffect(() => {
        if (user_inf) {
            setfullname(user_inf.fullname);
            setphonenumber(user_inf.phonenumber);
            setgender(user_inf.gender);
            setaddress(user_inf.address);
        }
    }, [user_inf]);
        ...
        <section className={styles.userinf}>
            ...
            <div className={`${styles.form_container} ${formDisplay===true ? styles.form_display : ""}`}> {/*form*/}
                        ...
                        <form onSubmit={(e) => { 
                            ...
                            setPopupVisible(true);    // Bật popup xác nhận
                        }}>
            ...
            {popupVisible && (
                ...
                <div className={styles.popup}>
                    ...
                    <div className={styles.btn}>
                        <button className={styles.btnhuy} onClick={() => setPopupVisible(false)}>Hủy</button>
                        <button className={styles.btnxacnhan} onClick={handleUpdate}>Xác nhận</button>
                    </div>
                </div>
                </div>
            )}
