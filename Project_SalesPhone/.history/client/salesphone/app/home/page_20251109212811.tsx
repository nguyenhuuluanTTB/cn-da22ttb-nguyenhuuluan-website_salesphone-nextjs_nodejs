        ...
        <section className={styles.home}> {/*sử dụng thẻ section sẽ tốt hơn cho seo */}
            ...
            <div className={styles.container}> {/*Đây là thẻ container chứa toàn bộ nội dung bên trong (hai bên mép thu lại)*/}
                ...
                <div className={styles.surveyContainer}>
                    <h2 className={styles.title}>Khảo sát đánh giá người dùng</h2>

                    <form className={styles.form}>
                        <div className={styles.question}>
                        <label>1. Bạn có hài lòng với sản phẩm không?</label>
                        ...
                        <div className={styles.question}>
                        <label>2. Phản hồi của bạn:</label>
                        <textarea className={styles.textarea} placeholder="Viết phản hồi..."></textarea>
                        </div>

                        <div className={styles.question}>
                        <label>3. Gợi ý cải thiện:</label>
                        <textarea className={styles.textarea} placeholder="Gợi ý của bạn..."></textarea>
                        </div>
