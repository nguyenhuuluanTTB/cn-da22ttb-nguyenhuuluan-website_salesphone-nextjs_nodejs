...
export default function Home () {
    ...
    const sidebarPosts = [
        ...
        { tag: "https://res.cloudinary.com/dnhyyioaf/image/upload/v1763020454/Galaxy_Z_Fold_6_i4di9b.jpg", type: "Đánh giá" , title: "10 mẹo tối ưu pin cho điện thoại Android", like: 156, cmt: 28 },
        { tag: "https://res.cloudinary.com/dnhyyioaf/image/upload/v1763020454/Galaxy_Z_Fold_6_i4di9b.jpg", type: "Đánh giá" , title: "So sánh iPhone 15 Pro Max vs Samsung S24 Ultra", like: 203, cmt: 67 },
                            ...
                            {sidebarPosts.map((post, i) => (
                                <div key={i} className={styles.sidebarCard}>
                                    ...
                                    <div className={styles.sidebarContent}>
                                        <div style={{padding: '3px 3px'}}><span style={{padding: '3px', border: 'solid 1px'}}>{post.type}</span></div>
                                        <h4>{post.title}</h4>
