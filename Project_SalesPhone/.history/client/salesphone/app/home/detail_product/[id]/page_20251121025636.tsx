                ...
                <div className={styles.gridContainer}>
                    ...
                    <div className={`${styles.item} ${styles.column_left}`}>
                        ...
                        <div className={styles.container_4content}> {/*hình ảnh mô tả*/}
                            ...
                            <div className={styles.content}><MdOutlinePhoneIphone style={{border:'2px solid red', padding:'3px', fontSize: '10pt'}}/><span>Nơi cung cấp những điện thoại mới và hot nhất trên thị trường</span></div>
                            <div></div>
                            <div></div>
                            <div></div>
