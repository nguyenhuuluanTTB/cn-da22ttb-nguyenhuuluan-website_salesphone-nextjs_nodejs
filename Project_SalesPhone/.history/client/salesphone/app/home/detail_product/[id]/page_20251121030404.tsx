                ...
                <div className={styles.gridContainer}>
                    ...
                    <div className={`${styles.item} ${styles.column_left}`}>
                        ...
                        <div className={styles.container_4content}> {/*hình ảnh mô tả*/}
                            ...
                            <div className={styles.content}><HiShieldCheck style={{border:'2px solid red', padding:'3px', fontSize: '40px', borderRadius:'8px'}}/><span>Bảo hành 12 tháng tại trung tâm bảo hành Chính hãng. 
1 đổi 1 trong 30 ngày nếu có lỗi phần cứng từ nhà sản xuất.</span></div>
                            <div className={styles.content}><FaMicrochip style={{border:'2px solid red', padding:'3px', fontSize: '40px', borderRadius:'8px'}}/><span>Nơi cung cấp những điện thoại mới và hot nhất trên thị trường</span></div>
