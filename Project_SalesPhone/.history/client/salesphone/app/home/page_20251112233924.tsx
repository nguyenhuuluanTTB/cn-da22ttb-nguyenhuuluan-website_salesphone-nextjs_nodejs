...
export default function Home () {
    ...
    const sidebarPosts = [
        { tag: "Đánh giá", title: "Galaxy Z Fold 6 - Smartphone gập tốt nhất 2024", like: 95, cmt: 32 },
        { tag: "Thủ thuật", title: "10 mẹo tối ưu pin cho điện thoại Android", like: 156, cmt: 28 },
        { tag: "So sánh", title: "So sánh iPhone 15 Pro Max vs Samsung S24 Ultra", like: 203, cmt: 67 },
        { tag: "Đánh giá", title: "Xiaomi 14 Ultra - Camera phone đỉnh cao", like: 87, cmt: 23 },
    ];
        ...
        <section className={styles.home}> {/*sử dụng thẻ section sẽ tốt hơn cho seo */}
            ...
            <div className={styles.container}> {/*Đây là thẻ container chứa toàn bộ nội dung bên trong (hai bên mép thu lại)*/}
                ...
                <section className={styles.wrapper_baiviet}>
                    <div className={styles.header_baiviet}>
                        <div>
                            ...
                            <h2 className={styles.title_baiviet}>BÀI VIẾT CÔNG NGHỆ</h2>
                            <p className={styles.subtitle}>Cập nhật tin tức mới nhất về công nghệ</p>
                        </div>
                        ...
                        <div className={styles.sliderArea}>
                            ...
                            <div className={styles.slider}>
                                ...
                                <div className={styles.sliderCard}>
                                    <Image src="/banner1.jpg" alt="news" width={350} height={200} />
                ...
                <div className={styles.container_article}>
                    <div className={styles.tab_header} style={{color: '#A70000', marginLeft:'2rem', fontSize: '13pt'}}> {/*tab_header */}
                            BÀI VIẾT CÔNG NGHỆ
                    </div>
