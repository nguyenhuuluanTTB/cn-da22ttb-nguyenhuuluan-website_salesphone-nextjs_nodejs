        ...
        <section className={styles.home}> {/*sử dụng thẻ section sẽ tốt hơn cho seo */}
            ...
            <div className={styles.container}> {/*Đây là thẻ container chứa toàn bộ nội dung bên trong (hai bên mép thu lại)*/}
                ...
                <div className={styles.container}>
                    {/* Layer dưới (background) */}
                    <div className={styles.background} />

                    {/* Layer trên (content) */}
                    <div className={styles.content}>
                        <Image src={slideshow1} alt="Face unlock" className={styles.faceImg}/>
                        <h1 className={styles.title}>Fast Face Unlock</h1>
                        <p className={styles.sub}>
                        Unlock your phone even in low light
                        </p>
                    </div>
                </div>
