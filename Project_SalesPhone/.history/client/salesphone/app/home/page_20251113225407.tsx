                            ...
                            <div className={styles.slideshow}>
                                ...
                                <div id="carouselExampleAutoplaying" className="carousel slide" data-bs-ride="carousel" >
                                    <div className="carousel-inner" style = {{borderRadius: '10px'}} >
                                        ...
                                        <Image src={slideshow1} style={{width: '100%'}}  alt="..."/>
                                        </div>
                                        <div className="carousel-item">
                                        <Image src={slideshow2} style={{width: '100%'}}  alt="..."/>
                                        </div>
                                        <div className="carousel-item">
                                        <Image src={slideshow3} style={{width: '100%'}}  alt="..."/>
                                        </div>
                                        <div className="carousel-item">
                                        <Image src={slideshow4} style={{width: '100%'}}  alt="..."/>
                                        </div>
                                        <div className="carousel-item">
                                        <Image src={slideshow5} style={{width: '100%'}}  alt="..."/>
                                        </div>
                                        <div className="carousel-item">
                                        <Image src={slideshow6} style={{width: '100%'}}  alt="..."/>
                                        </div>
                                        <div className="carousel-item">
                                        <Image src={slideshow7} style={{width: '100%'}}  alt="..."/>
                                        </div>
                                        <div className="carousel-item">
                                        <Image src={slideshow8} style={{width: '100%'}}  alt="..."/>
                                        </div>
                                    </div>
