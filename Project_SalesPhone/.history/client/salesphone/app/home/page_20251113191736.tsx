                    ...
                    <div className={styles.footerMayMan}>
                        <div className={styles.footerItemMayMan}>
                            <div style={ {display: 'flex', flexDirection: 'row', gap: '8px', alignItems: 'center'}}>
                                <div style={{backgroundColor: '#c4dfffff', padding: '5px', borderRadius: '7px', fontSize: '18pt', color: '#9097ffff'}}>< GoPeople /></div>
                        ...
                        <div className={styles.footerItemMayMan}>
                            <div style={ {display: 'flex', flexDirection: 'row', gap: '8px', alignItems: 'center'}}>
                                <div style={{backgroundColor: '#fff2c4ff', padding: '5px', borderRadius: '7px', fontSize: '18pt'}}>< GoTrophy /></div>
                        ...
                        <div className={styles.footerItemMayMan}>
                            <div style={ {display: 'flex', flexDirection: 'row', gap: '8px', alignItems: 'center'}}>
                                <div style={{backgroundColor: '#ffc4c4ff', padding: '5px', borderRadius: '7px', fontSize: '18pt'}}>< TiTicket  /></div>
