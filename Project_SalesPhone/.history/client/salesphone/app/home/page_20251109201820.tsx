                ...
                <div className={styles.container_article}>
                        <div className={styles.articles_wrapper}>
                            <div className={styles.articles_list}>
                                ...
                                <img src="/images/post1.jpg" alt="Bài viết 1" />
                                <h3>iPhone 16 Pro ra mắt — quá nhiều nâng cấp!</h3>
                                <p>Apple chính thức công bố dòng iPhone 16 Pro với chipset mạnh nhất...</p>
                                </div>

                                <div className={styles.article_card}>
                                <img src="/images/post2.jpg" alt="Bài viết 2" />
                                <h3>So sánh Galaxy S24 Ultra vs iPhone 16</h3>
                                <p>Màn hình xuất sắc, camera khác biệt — nên chọn máy nào?</p>
                                </div>

                                <div className={styles.article_card}>
                                <img src="/images/post3.jpg" alt="Bài viết 3" />
                                <h3>Top 5 smartphone đáng mua cuối 2025</h3>
                                <p>Tổng hợp smartphone tốt nhất theo từng phân khúc giá...</p>
                                </div>
