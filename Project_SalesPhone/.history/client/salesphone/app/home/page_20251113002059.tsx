...
export default function Home () {
    ...
    const sidebarPosts = [
        { tag: "📝", title: "Galaxy Z Fold 6 - Smartphone gập tốt nhất 2024", like: 95, cmt: 32 },
        { tag: "📝", title: "10 mẹo tối ưu pin cho điện thoại Android", like: 156, cmt: 28 },
        { tag: "📝", title: "So sánh iPhone 15 Pro Max vs Samsung S24 Ultra", like: 203, cmt: 67 },
        { tag: "📝", title: "Xiaomi 14 Ultra - Camera phone đỉnh cao", like: 87, cmt: 23 },
    ];
                        ...
                        <div className={styles.sidebar}>
                            {sidebarPosts.map((post, i) => (
                                <div key={i} className={styles.sidebarCard}>
                                    <div className={styles.tag}>{post.tag}</div> <br/>
