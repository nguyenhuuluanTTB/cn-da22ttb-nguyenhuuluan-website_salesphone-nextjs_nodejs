...
export default function Home () {
    ...
    const sidebarPosts = [
        { tag: "https://res.cloudinary.com/dnhyyioaf/image/upload/v1763025730/image_title_review_gultcd.png", type: "Đánh giá" , title: "Galaxy Z Fold 6 - Smartphone gập tốt nhất 2024", like: 95, cmt: 32 },
        { tag: "https://res.cloudinary.com/dnhyyioaf/image/upload/v1763027377/TIP_2_rm7sjr.png", type: "Thủ thuật" , title: "10 mẹo tối ưu pin cho điện thoại Android", like: 156, cmt: 28 },
        { tag: "https://res.cloudinary.com/dnhyyioaf/image/upload/v1763026662/ss_amkilv.png", type: "So sánh" , title: "So sánh iPhone 15 Pro Max vs Samsung S24 Ultra", like: 203, cmt: 67 },
        { tag: "https://res.cloudinary.com/dnhyyioaf/image/upload/v1763025730/image_title_review_gultcd.png", type: "Đánh giá" , title: "Xiaomi 14 Ultra - Camera phone đỉnh cao", like: 87, cmt: 23 },
    ];
            ...
            <div className={styles.container}> {/*Đây là thẻ container chứa toàn bộ nội dung bên trong (hai bên mép thu lại)*/}
                        ...
                        <div className={styles.item}>
                            ...
                            <div className={styles.list_brand}>
                                ...
                                <div className={styles.brand_list}>
                                        ...
                                        <div className={styles.brand_item}><span>IPHONE</span><span className={styles.arrow}><FiChevronRight/></span></div>
                                        
                                        <div className={styles.brand_item}><span>SAMSUNG</span><span className={styles.arrow}><FiChevronRight/></span></div>
                                        
                                        <div className={styles.brand_item}><span>OPPO</span><span className={styles.arrow}><FiChevronRight/></span></div>
                                        
                                        <div className={styles.brand_item}><span>REALME</span><span className={styles.arrow}><FiChevronRight/></span></div>
                                        
                                        <div className={styles.brand_item}><span>HUAWEI</span><span className={styles.arrow}><FiChevronRight/></span></div>
                                        
                                        <div className={styles.brand_item}><span>XIAOMI</span><span className={styles.arrow}><FiChevronRight/></span></div>
                                       
                                        <div className={styles.brand_item}><span>SONY</span><span className={styles.arrow}><FiChevronRight/></span></div>
                                </div>
                            ...
                            <div className={styles.grid}>
                                ...
                                return (
                                    <div key={phone.phone_id} className={styles.card}>
                                        ...
                                        <div className={styles.thongso}><span>{phone.screen_size}</span><span>{phone.ram}</span><span>{phone.rom}</span></div>
                            ...
                            <div className={styles.grid}>
                                ...
                                return (
                                    <div key={phone.phone_id} className={styles.card}>
                                        ...
                                        <div className={styles.thongso}> <span>6.9 iches</span><span>12 GB</span><span>512 GB</span></div>
                ...
                <section className={styles.wrapper_baiviet}>
                    ...
                    <div className={styles.tabContainer_baiviet}>
                        {tabs.map((tab) => (<button key={tab.key} className={`${styles.tabBtn} ${activeTab === tab.key ? styles.active : ""}`} onClick={() => setActiveTab(tab.key)}>{tab.label}</button>))}
                    </div>
