...
export default function Home () {
    ...
    const sidebarPosts = [
        { tag: "https://res.cloudinary.com/dnhyyioaf/image/upload/v1763020454/Galaxy_Z_Fold_6_i4di9b.jpg", title: "Galaxy Z Fold 6 - Smartphone gập tốt nhất 2024", like: 95, cmt: 32 },
        { tag: "https://res.cloudinary.com/dnhyyioaf/image/upload/v1763020454/Galaxy_Z_Fold_6_i4di9b.jpg", title: "10 mẹo tối ưu pin cho điện thoại Android", like: 156, cmt: 28 },
        { tag: "https://res.cloudinary.com/dnhyyioaf/image/upload/v1763020454/Galaxy_Z_Fold_6_i4di9b.jpg", title: "So sánh iPhone 15 Pro Max vs Samsung S24 Ultra", like: 203, cmt: 67 },
        { tag: "https://res.cloudinary.com/dnhyyioaf/image/upload/v1763020454/Galaxy_Z_Fold_6_i4di9b.jpg", title: "Xiaomi 14 Ultra - Camera phone đỉnh cao", like: 87, cmt: 23 },
    ];
                            ...
                            {sidebarPosts.map((post, i) => (
                                <div key={i} className={styles.sidebarCard}>
                                    <div className={styles.tag}> 
                                        <Image
                                            src="https://res.cloudinary.com/dnhyyioaf/image/upload/v1763020454/Galaxy_Z_Fold_6_i4di9b.jpg"
                                            alt="Galaxy Z Fold 6"
                                            width={800}
                                            height={600}
                                        />
