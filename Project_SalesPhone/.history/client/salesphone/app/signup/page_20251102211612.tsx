            ...
            <section className={styles.signup}>
                ...
                <div className={styles.container}> {/*container */}
                    ...
                    <h2>
                     ...
                     <div className="mb-3">
                        <label htmlFor="staticEmail" className="col-sm-4 col-form-label">Tên tài khoản <span style = {{color: 'red'}}>*</span></label>
                    ...
                    <div className="mb-3">
                        <label htmlFor="inputPassword" className="col-sm-3 col-form-label">Mật khẩu <span style = {{color: 'red'}}>*</span></label>
                        <div className="col-sm-12">
                            <input
                                type="password"
                                className="form-control"
                    ...
                    <div className="mb-3">
                        <label htmlFor="inputPassword" className="col-sm-5 col-form-label">Xác nhận mật khẩu <span style = {{color: 'red'}}>*</span></label>
                        <div className="col-sm-12">
                            <input
                                type="password"
                                className="form-control"
