                ...
                <div className={styles.gridContainer}> {/*Đây là phần content {grid} */}
                    ...
                    <div className={styles.item}>
                        <div className={styles.tongcong}>
                            ...
                            <ul>
                                <li><span style={{color: 'green'}}>Bảo hành chính hãng 12 tháng</span></li>
                                <li><span style={{color: 'green'}}>Đổi trả trong 7 ngày</span></li>
                                <li><span style={{color: 'green'}}>Thanh toán an toàn & bảo mật</span></li>
                            </ul>
