                    ...
                    <div className={styles.item}>
                        <div className={styles.tongcong}>
                            ...
                            <button onClick={(e) => {
                                e.preventDefault();
                                handleCheckout();
                            }} style={{ textDecoration: 'none', color: '#fff', border: 'none', background: '#A70000', padding: '1rem 2rem', borderRadius: '10px', cursor: 'pointer', fontSize: '1rem', fontWeight: 'bold' }}>
                                Tiến hành đặt hàng
                            </button>
            ...
            {showQRPopup && (
                <div className={qrStyles.qrPopupOverlay} onClick={() => setShowQRPopup(false)}>
                    <div className={qrStyles.qrPopupContent} onClick={(e) => e.stopPropagation()}>
                        ...
                        <p className={qrStyles.orderInfo}>Mã đơn hàng: <strong>{orderData.orderId}</strong></p>
                        <p className={qrStyles.orderInfo}>Số tiền: <strong style={{color: '#A70000'}}>{orderData.amount.toLocaleString('vi-VN')}đ</strong></p>
                        ...
                        <button className={qrStyles.confirmBtn} onClick={() => {
