            ...
            {showQRPopup && (
                <div className={qrStyles.qrPopupOverlay} onClick={() => setShowQRPopup(false)}>
                    <div className={qrStyles.qrPopupContent} onClick={(e) => e.stopPropagation()}>
                        ...
                        <p className={qrStyles.orderInfo}>Mã đơn hàng: <strong>{orderData.orderId}</strong> | Số tiền: <strong style={{color: '#A70000'}}>{orderData.amount.toLocaleString('vi-VN')}đ</strong></p>
