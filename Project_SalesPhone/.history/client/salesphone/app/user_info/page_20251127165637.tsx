    ...
    const fetchUserInfo = async () => {
        ...
        try {
            ...
            const normalized: UserInformation = {
                fullname: p.fullname ?? 'Loading...',
                phonenumber: p.phonenumber ?? 'Loading...',
                gender: p.gender ?? 'Loading...',
                address: p.address ?? 'Loading...',
                name: p.name ?? 'Loading...',
                        ...
                        <table>
                            <tbody >
                                ...
                                <tr>
                                    ...
                                    <td className="border p-2">{user_inf?.phonenumber == '' || null ? "Chưa có dữ liệu" : user_inf?.phonenumber}</td>
                                </tr>
                                {/* <tr>
