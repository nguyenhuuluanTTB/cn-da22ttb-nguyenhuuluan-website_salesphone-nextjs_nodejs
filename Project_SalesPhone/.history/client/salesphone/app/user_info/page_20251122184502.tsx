    ...
    return(
        <section className={styles.userinf}>
            ...
            <div className={styles.form_container}> {/*form*/}
                        ...
                        <form>
                            <div style={{display: 'flex', justifyContent: 'end', marginBottom: '2rem', fontSize: '16pt'}} className={styles.closeIcon}><FaRegWindowClose/></div>
