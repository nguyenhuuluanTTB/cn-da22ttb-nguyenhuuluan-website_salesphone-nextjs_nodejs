...
export default function Header () {
    ...
    <nav className={styles.bottomNav}>
        <Link href="#"><FaStore /><span>Trang chủ</span></Link>
        <Link href="#"><FaBoxOpen /><span>Tra cứu</span></Link>
        <Link href="#"><FaStore /><span>Cửa hàng</span></Link>
        <Link href="#"><FaUser /><span>Tài khoản</span></Link>
    </nav>
