    ...
    <footer className={styles.footer}>
      <div className={styles.container}>
        ...
        <div className={styles.column}>
          ...
          <p><strong>Địa chỉ:</strong> 350-352 Võ Văn Kiệt, Phường Cầu Ông Lãnh, TP. Hồ Chí Minh</p>
          <p><strong>Điện thoại:</strong> 028 7108 9666</p>
          <p><strong>Giờ làm việc:</strong> 06:30 - 23:30 hằng ngày</p>
          <p><strong>Liên hệ:</strong> 028 7108 9666</p>
        </div>
