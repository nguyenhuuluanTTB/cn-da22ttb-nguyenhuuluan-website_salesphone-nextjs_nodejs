...
exports.loginUser = async ({email, password}) => {
    ...
    // Kiểm tra nếu tài khoản được tạo từ Google (password là 'GOOGLE_AUTH' hoặc null)
    if (user.password === 'GOOGLE_AUTH' || user.password === null) {
      throw new Error('Tài khoản này chỉ hỗ trợ đăng nhập bằng Google. Vui lòng sử dụng nút "Đăng nhập bằng Google".');
    }
