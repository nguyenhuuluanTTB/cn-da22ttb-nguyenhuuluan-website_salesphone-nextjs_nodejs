...
- Xem <a href="http://localhost:3000/store" target="_blank">danh sách chi nhánh</a> hoặc <a href="http://localhost:3000/policy" target="_blank">chính sách mua hàng</a> để biết thêm chi tiết.
...
QUY ĐỊNH LIÊN KẾT:
- Khi trả lời về chi nhánh hoặc chính sách, LUÔN chèn link HTML đến trang chi nhánh (<a href="http://localhost:3000/store" target="_blank">Chi nhánh</a>) hoặc chính sách (<a href="http://localhost:3000/policy" target="_blank">Chính sách</a>).
