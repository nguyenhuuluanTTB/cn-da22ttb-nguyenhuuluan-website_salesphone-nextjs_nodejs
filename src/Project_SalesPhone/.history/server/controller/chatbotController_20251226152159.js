...
<div style="background:#f8fafc;border-radius:10px;padding:16px 18px;margin:12px 0 18px 0;font-family:sans-serif">
  ...
  <ul style="margin:0 0 8px 18px;padding:0;font-size:15px">
    ...
    <li><b>Website:</b> <a href="http://localhost:3000" target="_blank" style="color:#2563eb;text-decoration:underline">salesphone.vn</a></li>
    <li><b>Chi nhánh:</b> <a href="http://localhost:3000/store/branches" target="_blank" style="color:#2563eb;text-decoration:underline">Xem danh sách</a></li>
