...
const GEMINI_API_KEY = process.env.GEMINI_API_KEY || 'AIzaSyCcRXmPGl1Oxo7N6tjOY59cd1BFvAt6by8';
...
- Mỗi sản phẩm là một card với style đẹp (border, border-radius:12px, padding:16px, box-shadow)
- BẮT BUỘC hiển thị ảnh từ trường "image" bằng <img> (width:100%, max-width:250px, height:180px, object-fit:cover, border-radius:8px)
- Hiển thị: Tên sản phẩm (h3, màu #667eea), Giá (số + ₫, màu đỏ #ef4444), RAM/ROM, Pin, Chip, HĐH
- QUAN TRỌNG: Hiển thị số lượng tồn kho:
  + Nếu quantity > 0: "📦 Còn [số] sản phẩm" (background:#10b981, color:white, padding:6px 12px, border-radius:6px)
...
- Layout: Dùng flexbox hoặc grid để hiển thị card đẹp mắt
