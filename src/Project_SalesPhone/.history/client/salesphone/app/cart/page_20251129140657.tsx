                        ...
                        <div className={styles.tongcong}>
                            ...
                            <div className={styles.tong_gia}>
                                ...
                                <div style={{display: 'flex', flexDirection: 'column', alignItems: 'end'}}>
                                    <span style={{fontSize: '22pt'}}>31.990.000đ</span>
                            ...
                            <ul>
                                <li><span style={{color: 'rgb(94, 94, 94)'}}>Bảo hành chính hãng 12 tháng</span></li>
                                <li><span style={{color: 'rgb(94, 94, 94)'}}>Đổi trả trong 7 ngày</span></li>
                                <li><span style={{color: 'rgb(94, 94, 94)'}}>Thanh toán an toàn & bảo mật</span></li>
                            </ul>
