...
export default function Cart () {
    ...
    const tongtien = phones.reduce((total, phone) => {
        const discountedPrice =
            phone.percent > 0
                ? Math.round(phone.price * (1 - phone.percent / 100))
                : phone.price;
        
        return total + discountedPrice * phone.quantity; // nhân quantity nếu cần
    }, 0);
    
    const sosp = phones.reduce((sl, phone) => {
        return sl + phone.quantity
    }, 0);
                                ...
                                <div className={styles.left}>
                                    ...
                                    <div className={styles.inf}> {/*thông tin */}
                                        ...
                                        <div className={styles.quantity}> {/*Điều chỉnh số lượng */}
                                            ...
                                            <span style={{fontSize: '15pt'}}>Số lượng sản phẩm: {phone.quantity}</span>
                    ...
                    <div className={styles.item}>
                        <div className={styles.tongcong}>
                            ...
                            <div className={styles.giasp}>
                                <span style={{color: 'rgb(94, 94, 94)'}}>Tạm tính ({} sản phẩm)</span>
