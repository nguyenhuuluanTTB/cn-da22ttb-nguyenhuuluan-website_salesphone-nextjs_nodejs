...
export default function Cart() {
    ...
    return (
        <section className={styles.cart}>
                    ...
                    <div className={styles.item}>
                        <div className={styles.tongcong}>
                            ...
                            <Link href='/order' style={{ textDecoration: 'none', color: '#fff' }}>
                                <button onClick={handleCheckout} type="button">Tiến hành đặt hàng</button>
                            </Link>
            ...
            {showQRPopup && (
                <div className={styles.qrPopupOverlay} onClick={() => setShowQRPopup(false)}>
                    <div className={styles.qrPopupContent} onClick={(e) => e.stopPropagation()}>
                        <button className={styles.closeBtn} onClick={() => setShowQRPopup(false)}>×</button>
                        
                        <h2>Quét mã QR để thanh toán</h2>
                        <p className={styles.orderInfo}>Mã đơn hàng: <strong>{orderData.orderId}</strong></p>
                        <p className={styles.orderInfo}>Số tiền: <strong style={{color: '#A70000'}}>{orderData.amount.toLocaleString('vi-VN')}đ</strong></p>
                        
                        <div className={styles.qrCodeContainer}>
                            <img 
                                src={`https://qr.sepay.vn/img?acc=0374057078&bank=VPBank&amount=${orderData.amount}&des=${orderData.orderId}`}
                        ...
                        <div className={styles.bankInfo}>
                            ...
                            <p><strong>Nội dung:</strong> {orderData.orderId}</p>
                        </div>
