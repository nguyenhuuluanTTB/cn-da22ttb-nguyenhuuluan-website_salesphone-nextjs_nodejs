            ...
            <div className={styles.container}> {/*container */}
                ...
                <div className={styles.gridContainer}>
                    ...
                    <div className={`${styles.item} ${styles.item1}`}>
                        ...
                        <div className={styles.thongtindiachi}>
                                <div className={styles.title_location}><IoLocation style={{color:'green', fontWeight: 'bold'}}/><span>Phương thức thanh toán</span></div>
                        ...
                        {/*Ghi chú */}
                        <div className={styles.thongtindiachi}>
                            <div className={styles.title_location}><IoLocation style={{color:'green', fontWeight: 'bold'}}/><span>Ghi chú đơn hàng</span></div>
                            <input style={{width: '100%'}} type="text" placeholder='Ghi chú thêm (tùy chọn)' />
                        </div>
