    ...
    return(
        <section className={styles.home}> {/*sử dụng thẻ section sẽ tốt hơn cho seo */}
            ...
            <div className={styles.container}> {/*Đây là thẻ container chứa toàn bộ nội dung bên trong (hai bên mép thu lại)*/}
                ...
                <section className={styles.hero} aria-label="About SalesPhone">
      <div className={styles.inner}>
        ...
        <h1 className={styles.title}>
          Muốn hiểu hơn
          <br />
          về <span className={styles.accent}>SalesPhone</span> ?
        </h1>

        <p className={styles.lead}>
          Công nghệ tiên tiến — dịch vụ chu đáo — giá tốt. Khám phá thêm về chúng tôi.
        </p>
