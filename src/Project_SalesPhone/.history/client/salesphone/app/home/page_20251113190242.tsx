                ...
                <div className={styles.containerMayMan}>
                    ...
                    <div className={styles.footerMayMan}>
                        <div className={styles.footerItemMayMan}>
                            <div style={{fontSize: '20pt', display: 'flex', flexDirection: 'row', gap: '8px', alignItems: 'center'}}>
                                <div style={{backgroundColor: '#c4dfffff', padding: '5px', borderRadius: '7px', fontSize: '16pt'}}>< GoPeople /></div>
                                <span>Người chơi hôm nay</span>
                            </div>
                            <span style={{fontSize: '30pt'}}>12,458</span>
                        </div>
                        <div className={styles.dividerMayMan}></div>
                        <div className={styles.footerItemMayMan}>
                            <div style={{fontSize: '20pt'}}>Giải thưởng đã trao</div>
                            <span style={{fontSize: '30pt'}}>8,921</span>
                        </div>
                        <div className={styles.dividerMayMan}></div>
                        <div className={styles.footerItemMayMan}>
                            <div style={{fontSize: '20pt'}}>Lượt quay còn lại</div>
