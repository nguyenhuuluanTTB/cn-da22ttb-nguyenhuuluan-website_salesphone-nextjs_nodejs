                ...
                <div className={styles.containerMayMan}>
                    ...
                    <div className={styles.footerMayMan}>
                        <div className={styles.footerItemMayMan}>
                            <p style={{fontSize: '20pt'}}>Người chơi hôm nay</p>
                            <strong style={{fontSize: '20pt'}}>12,458</strong>
                        </div>
                        <div className={styles.dividerMayMan}></div>
                        <div className={styles.footerItemMayMan}>
                            <p style={{fontSize: '20pt'}}>Giải thưởng đã trao</p>
                            <strong style={{fontSize: '20pt'}}>8,921</strong>
                        </div>
                        <div className={styles.dividerMayMan}></div>
                        <div className={styles.footerItemMayMan}>
                            <p style={{fontSize: '20pt'}}>Lượt quay còn lại</p>
                            <strong className={styles.remainingMayMan} style={{fontSize: '20pt'}}>1</strong>
                        </div>
                    </div>
                </div>
