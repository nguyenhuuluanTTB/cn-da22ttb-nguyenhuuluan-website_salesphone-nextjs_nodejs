        ...
        <section className={styles.home}> {/*sử dụng thẻ section sẽ tốt hơn cho seo */}
            ...
            <div className={styles.container}> {/*Đây là thẻ container chứa toàn bộ nội dung bên trong (hai bên mép thu lại)*/}
                ...
                <div className={styles.icon}>
                    ...
                    <path fill="#E11" d="M12 2l3 2 3 1 1 3v6l-1 3-3 1-3 2-3-2-3-1-1-3V8l1-3 3-1 3-2z"/>
                    <path fill="#fff" d="M12 7.5a4.5 4.5 0 100 9 4.5 4.5 0 000-9zm0 2.25a2.25 2.25 0 110 4.5 2.25 2.25 0 010-4.5z"/>
                    </svg>
                </div>
                <h4 className={styles.title}>Thương hiệu đảm bảo</h4>
                <p className={styles.subtitle}>Nhập khẩu, bảo hành chính hãng</p>
                </div>

                <div className={styles.card} tabIndex={0}>
                <div className={styles.icon}>
                    <svg viewBox="0 0 24 24" width="36" height="36" aria-hidden>
                    <path fill="#E11" d="M6 3v6h2V6.4l5.3 5.3-1.4 1.4L6.6 7.8V11H4V3h2zM18 21v-6h-2v2.6L10.7 12.3l1.4-1.4L17.4 16.2V13H20v8h-2z"/>
                    </svg>
                </div>
                <h4 className={styles.title}>Đổi trả dễ dàng</h4>
                <p className={styles.subtitle}>Theo chính sách đổi trả tại FPT Shop</p>
                </div>

                <div className={styles.card} tabIndex={0}>
                <div className={styles.icon}>
                    <svg viewBox="0 0 24 24" width="36" height="36" aria-hidden>
                    <path fill="#E11" d="M3 6h11v7h-1l-1 3H8l-1-3H3V6zm16 3h2l1 3h-3v-3zM7 18a1.5 1.5 0 110 3 1.5 1.5 0 010-3zm10 0a1.5 1.5 0 110 3 1.5 1.5 0 010-3z"/>
                    </svg>
                </div>
                <h4 className={styles.title}>Giao hàng tận nơi</h4>
                <p className={styles.subtitle}>Trên toàn quốc</p>
                </div>

                <div className={styles.card} tabIndex={0}>
                <div className={styles.icon}>
                    <svg viewBox="0 0 24 24" width="36" height="36" aria-hidden>
                    <path fill="#E11" d="M12 2l2.7 5.5L20 9l-4 3.6L17 20l-5-2.6L7 20l1-7.4L4 9l5.3-1.5L12 2z"/>
                    <path fill="#fff" d="M11 14l-2-2 1-1 1 1 3-3 1 1-4 4z"/>
                    </svg>
                </div>
                <h4 className={styles.title}>Sản phẩm chất lượng</h4>
                <p className={styles.subtitle}>Đảm bảo tương thích và độ bền cao</p>
                </div>
