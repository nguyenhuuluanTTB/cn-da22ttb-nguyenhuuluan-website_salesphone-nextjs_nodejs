                                ...
                                <div className={styles.sliderCard}>
                                    ...
                                    <div className={styles.sliderInfo}>
                                        ...
                                        <div style={{display: 'flex', flexDirection: 'row', justifyContent: 'space-between'}}>
                                            ...
                                            <div style={{display: 'flex', flexDirection: 'row'}} className={styles.social}>
                                                <span style={{display: 'flex', flexDirection: 'row', alignItems: 'center'}}><FaRegHeart />&nbsp; 120</span>&nbsp; <span><FaRegComment/> 45</span>
                                            </div>
                                        </div>
