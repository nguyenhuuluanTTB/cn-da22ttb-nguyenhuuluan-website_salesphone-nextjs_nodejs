                    ...
                    <div className={`${styles.item} ${styles.column_left}`}>
                        ...
                        <div className={styles.table}> {/*table thông số */}
                            ...
                            <table >
                                <tbody>
                                    <tr>
                                        <td className="border p-2 font-semibold" style={{backgroundColor:'#AFAFAF'}}>Kích thước màn hình</td>
                                        <td className="border p-2">6.9 inches</td>
                                    </tr>
                                    <tr>
                                        <td className="border p-2 font-semibold">Công nghệ màn hình</td>
                                    ...
                                    <tr>
                                        <td className="border p-2 font-semibold">Thẻ SIM</td>
                                        <td className="border p-2">2 Nano-SIM + eSIM</td>
                                    </tr>
                                    <tr>
                                        <td className="border p-2 font-semibold">Hệ điều hành</td>
                                        <td className="border p-2">Android 15</td>
                                    </tr>
                                    <tr>
                                        <td className="border p-2 font-semibold">Độ phân giải màn hình</td>
                                        <td className="border p-2">3120 x 1440 pixels (Quad HD+)</td>
                                    </tr>
                                    <tr>
                                        <td className="border p-2 font-semibold">Tính năng màn hình</td>
                                        <td className="border p-2">
                                            120Hz<br />
                                            2600 nits<br />
