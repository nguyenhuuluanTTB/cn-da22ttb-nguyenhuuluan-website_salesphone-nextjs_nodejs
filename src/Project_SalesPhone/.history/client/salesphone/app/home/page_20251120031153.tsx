                            ...
                            <div className={styles.slideshow} style={{width: '100%'}}>
                                ...
                                <div id="carouselExampleAutoplaying" className="carousel slide" data-bs-ride="carousel" >
                                    <div  style = {{borderRadius: '10px'}} >
                                        <div className="carousel-item active" ><Image src={slideshow1}  alt="..." style = {{borderRadius: '10px'}}/></div>
                                        <div className="carousel-item"><Image src={slideshow2}  alt="..." style = {{borderRadius: '10px'}}/></div>                                       
