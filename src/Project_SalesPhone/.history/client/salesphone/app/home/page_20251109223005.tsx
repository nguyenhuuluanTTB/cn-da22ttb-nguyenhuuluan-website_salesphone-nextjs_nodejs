      ...
      <div className={styles.track}>
        ...
        <div className={styles.slide}>
          <div>
            ...
            <p className={styles.highlight}>Nhân viên tận tình, chu đáo, sẵn sàng hỗ trợ khách hàng</p>
          </div>
          <img src="/images/chinhanh1.png" alt="Chi nhánh 1" />
        </div>
        ...
        <div className={styles.slide}>
          <div>
            ...
            <p className={styles.highlight}>Dịch vụ nhanh chóng, sản phẩm chính hãng, giá tốt</p>
          </div>
          <img src="/images/chinhanh2.png" alt="Chi nhánh 2" />
        </div>

        {/* Lặp lại để tạo hiệu ứng vòng tròn */}
        <div className={styles.slide}>
          <div>
            <p><b>Địa chỉ:</b> 350-352 Võ Văn Kiệt, Phường Cầu Ông Lãnh, TP. Hồ Chí Minh.</p>
            <p><b>Điện thoại:</b> 028 7108 9666</p>
